<!--
============================================================================
  GITHUB PROFILE README  ·  Paul Vargas Linares (@paulvl-forge)  ·  ENGLISH
============================================================================
  HOW TO USE:
  1. Create a PUBLIC repository with the EXACT same name as your username:
        paulvl-forge/paulvl-forge
  2. Upload this file as README.md in that repo.
  3. Done! It will automatically appear on your profile.

  NOTE: Stats cards use the public github-readme-stats instance.
  If you see "Maximum retries exceeded" it's a temporary rate-limit — try
  again later, or deploy your own instance:
...
🇵🇪 **Software Engineer specialized in AI** (Bachelor's degree – SENATI, Lima). I bridge frontend and backend development, build **BI dashboards** directly integrated with production ERPs, **automate workflows with n8n**, and deploy **RAG chatbots** that answer with verified data — zero hallucinations. Fast learner who delivers from day one.

```python
class PaulVargas:
    def __init__(self):
        self.role       = "Software Engineer with AI"
        self.location   = "Callao, Lima · Peru 🇵🇪"
...
- 🔭 Building a **real-time web BI system integrated with ERP** at **Tacctial IT** — live metrics, dynamic filters, full frontend & backend modules.
- 🌱 Going deeper into **generative AI, RAG architecture and n8n automation**.
- ⚡ AI-assisted development with **Claude Code**.
- 🤖 Previously built a **RAG chatbot** (n8n + Supabase + PostgreSQL) and a **facial recognition system** with OpenCV + AWS.
- 💬 Ask me about: **Python, automation, BI dashboards, OpenCV, REST APIs, AWS**.
...
<img src="https://img.shields.io/badge/RAG%20Architecture-0D1117?style=for-the-badge&logoColor=00E5FF"/>
...
<img src="https://img.shields.io/badge/Excel%20Advanced-0D1117?style=for-the-badge&logo=microsoftexcel&logoColor=00E5FF"/>
...
> 🪐 **RecoFacial** — Computer vision system that classifies in real time whether a person is an employee or intruder; stores intrusions with automatic photo in **Amazon S3** and migrated the database from SQLite → **MySQL (RDS)**.
> 🤖 **websitechatbot** — Chatbot with **RAG architecture** (n8n + Supabase + PostgreSQL) with verified, hallucination-free responses.
> 🏨 **WebHotelPHP** — Responsive hotel booking website with client registration (PHP).
> 🎓 **Enrollment System (Java)** — CRUD desktop system for student enrollment, grades and academic modules.

### 🔒 Professional & In-Development Work (Private)

- 🛰️ **tactical-bi** · `Python` — Enterprise real-time dashboard directly integrated with Tacctial IT's **production ERP**.
- 🧾 **Facturador** · `Vue` — Invoicing system (requirements analysis, UML diagrams and Figma design).
- 🏷️ **SUBASTAS** · `TypeScript` — Auction platform.
...
<img src="https://img.shields.io/badge/Cisco-Networking%20%7C%20IoT%20%7C%20Cybersecurity-0D1117?style=for-the-badge&logo=cisco&logoColor=1BA0D7"/>

<sub>📜 Full list on my <a href="https://linkedin.com/in/paul-vargasl">LinkedIn</a> · Oracle (Java, Database Design, SQL), Cisco (Data Science), Red Hat (RH124) and more.</sub>
...
<!--
  ⚙️ TO ENABLE THE SNAKE:
  Create .github/workflows/snake.yml in this same repo with:
  ...
  Then go to Actions tab → "Generate Snake" → Run workflow manually once.
-->
...
<a href="mailto:Paulvargas529@gmail.com"><img src="https://img.shields.io/badge/Send%20a%20Mail-EA4335?style=for-the-badge&logo=gmail&logoColor=white"/></a>
<img src="https://img.shields.io/badge/WhatsApp-%2B51%20919%20623%20622-25D366?style=for-the-badge&logo=whatsapp&logoColor=white"/>
